...
class MyAppState extends State<MyApp> {
  ...
  void updateState() {
    guiRpc("get_state").then((http.Response response) {
  ...
  Future<http.Response> guiRpc(String request) async {
    ...
    if (authId != null) {
      ...
      header = {"Auth-ID": "$authId", "Auth-Seqno": "$authSeqno", "Auth-Hash": authHash};
      authSeqno++;
    }
    header = {
      ...header,
    ...
    return await http.post(url, headers: header, body: requestXml, encoding: latin1);
  }
  ...
  Future<void> connectClient() {
    ...
    return guiRpc("get_auth_id").then((http.Response response) {
