...
copy "win_build\Build\x64\Release\boinccmd.exe" "samples\flutter\boinc\assets\windows\boinccmd.exe"
copy "curl\ca-bundle.crt" "samples\flutter\boinc\assets\windows\ca-bundle.crt"
