...
#
#
# Script to build Macintosh 64-bit Intel library of nghttp2 for
...
if [ $GCC_can_build_arm64 = "yes" ]; then
    ...
    if [ $? -ne 0 ]; then
        echo "              ******"
        echo "nghttp2: x86_64 build succeeded but could not build for arm64."
        echo "              ******"
    else        
        ...
        mv -f "${libPath}/libnghttp2.a" libnghttp2_x86_64.a
        ...
        mv -f "${libPath}/libnghttp2.a" libnghttp2_arm64.a

        # combine x86_64 and arm libraries
        lipo -create libnghttp2_x86_64.a libnghttp2_arm64.a -output "${libPath}/libnghttp2.a"
        if [ $? -ne 0 ]; then
            rm -f libnghttp2_x86_64.a libnghttp2_arm64.a
            return 1
         fi
