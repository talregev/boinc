...
class StorageControlsListAdapter(
    context: Context,
    // ID of control texts in strings.xml
    private val entries: List<StorageControl>
) : ArrayAdapter<StorageControl>(
    ...
    override fun getItem(position: Int): StorageControl {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        when (data.operation) {
            ...
            StorageFragment.VISIT_WEBSITE -> text =
